...
- [🔧 `config`](#config)
- [☁️ 🆙 `publish`](#publish)
  * [workers.dev](#publishing-to-workers-dev)
  * [Publishing to your own domain](#publishing-to-your-own-domain)
  * [Publishing the same code to multiple places](#publishing-the-same-code-to-multiple-places)
- [👂 `dev`](#dev-alpha-)
- [🔬 `preview`](#preview)
  * [Making it work with WSL](#previewing-on-windows-subsytem-for-linux-wsl-1-2-)
- [🗂️ `kv`](#kv)
- [🤫 `secret`](#secret)
